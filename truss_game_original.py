...
while running:
    ...
    if generate_truss:
        ...
        triangles = scipy.spatial.Delaunay([700,500] * np.random.rand(num_nodes, 2) + 100)
    ...
    if not simulation_running:
        screen.blit(small_font.render("Click where you think the blue node will move!", True, (255,255,255)), (200,800))
